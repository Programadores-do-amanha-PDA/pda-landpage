        ...
        <div className="w-full">
          <ListboxButton
            className={clsx(
              ...
              "items-center justify-between flex data-[open]:rounded-r-none transition-all relative"
            )}
          >
            <span className="text-sm font-normal">
              {selectedItems.join(", ")}
            </span>
            <ChevronRightIcon className="size-5 fill-gray-50/60 group-data-[hover]:fill-gray-50 dark:fill-gray-900/60 dark:group-data-[hover]:fill-gray-900" />
          </ListboxButton>
        </div>
