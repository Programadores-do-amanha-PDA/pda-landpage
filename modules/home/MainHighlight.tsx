        ...
        <Layout className="justify-center h-full items-center relative max-w-7xl p-6 lg:p-8 overflow-x-hidden">
          <Column className="w-full relative justify-between items-center h-full">
            <Text className="text-xl sm:text-2xl md:text-3xl xl:text-4xl md:lg:max-w-2xl lg:max-w-3xl xl:max-w-5xl font-dela-gothic dark:text-gray-50 text-gray-900 text-center max-w-2xl prose lg:prose-xl z-[5]">
              ...
              <Text className="text-primary-500 font-black font-ibm-plex">
                {">"}
              </Text>
            </Text>
            ...
            <Column className="w-full gap-4 sm:flex-row items-center justify-center">
              <Button
                className={`p-1 h-12 px-2 w-full relative flex items-center justify-center sm:justify-between bg-primary-500 text-gray-900 rounded-xl gap-2 font-roboto font-semibold sm:max-w-xs`}
              ...
              <InternalLink
                ...
                className={`p-1 h-12 px-2 w-full relative flex items-center justify-center border-2 transition-all border-primary-500 hover:bg-primary-500/55 text-gray-900 dark:text-gray-50 rounded-xl gap-2 font-roboto font-semibold sm:max-w-52`}
              >
                Contrate um Talento
              </InternalLink>
            </Column>
