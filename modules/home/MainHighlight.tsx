        ...
        <Layout className="justify-center h-full items-center relative max-w-7xl p-6 lg:p-8 overflow-x-hidden">
          <Column className="w-full relative justify-between items-center h-full">
            ...
            <Column className="w-full gap-4 sm:flex-row items-center justify-center">
              <Button
                className={`p-1 h-12 px-2 w-full relative flex items-center justify-center sm:justify-between bg-yellow-400 text-gray-900 rounded-xl gap-2 font-roboto font-semibold sm:max-w-xs`}
              ...
              <InternalLink
                ...
                className={`p-1 h-12 px-2 w-full relative flex items-center justify-center border-2 transition-all border-yellow-400 hover:bg-yellow-400/55 text-gray-900 dark:text-gray-50 rounded-xl gap-2 font-roboto font-semibold sm:max-w-52`}
              >
                Contrate um Talento
              </InternalLink>
            </Column>
          ...
          <Row className="w-44 sm:w-64 xl:w-72 absolute -left-16 bottom-36 md:bottom-24 md:left-0 -z-0">
            <Image
          ...
          <Row className="w-40 sm:w-60 xl:w-64 absolute -right-10 md:right-0 bottom-40 md:bottom-20 -z-0">
            <Image
