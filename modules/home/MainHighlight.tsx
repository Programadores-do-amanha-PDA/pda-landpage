        ...
        <Layout className="justify-center h-full items-center relative max-w-7xl p-6 lg:p-8 overflow-x-hidden">
          <Column className="w-full relative justify-between items-center h-full">
            ...
            <Column className="w-full gap-4 sm:flex-row items-center justify-center">
              <Button
                className={`p-1 h-12 px-2 w-full relative flex items-center justify-center sm:justify-between bg-primary-500 text-gray-900 rounded-xl gap-2 font-roboto font-semibold sm:max-w-xs shadow-md`}
              ...
              <InternalLink
                ...
                className={`p-1 h-12 px-2 w-full relative flex items-center justify-center border-2 transition-all border-secondary-500 hover:bg-secondary-500/55 text-gray-900 dark:text-gray-50 rounded-xl gap-2 font-roboto font-semibold sm:max-w-52 shadow-sm`}
              >
                Contrate um Talento
              </InternalLink>
            </Column>
