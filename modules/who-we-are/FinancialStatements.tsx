...
const FinancialStatements = () => {
  return (
    <Row className="justify-center p-6 md:p-10 items-center overflow-x-hidden w-full h-full bg-secondary-400 dark:bg-secondary-700">
      <Layout className="w-full max-w-7xl min-h-[300px] flex-col gap-20 !justify-between items-start flex-wrap">
        <Column className="w-full text-start gap-4">
          ...
          <Text className="font-ibm-plex-sans-sans font-semibold text-lg text-gray-900 dark:text-gray-50">
            Abaixo estão nossos demonstrativos contábeis onde você pode
            acompanhar como os recursos estão sendo gerenciados e utilizados
            pela Programadores do Amanhã.
          </Text>
        </Column>
